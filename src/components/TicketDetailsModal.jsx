    ...
    return (
        <dialog id="ticket_modal" className="modal">
            <div className="modal-box">
                ...
                <h3 className="font-bold  text-white text-lg">{currentTicket.title}</h3>
                ...
                <div className="modal-action">
                    ...
                    <button
                        ...
                        className="btn-success btn px-4 py-2 rounded-md hover:bg-green-400 transition-all ease-in-out duration-300 font-semibold text-lg"
                    >
                        Update ticket
                    </button>
