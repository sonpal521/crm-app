...
function CreateTicket() {
    ...
    return (
        <HomeLayout>
         <div className="min-h-[90vh] flex items-center mt-14 mb-14 justify-center">

<form 
    onSubmit={onFormSubmit}
    className="w-full max-w-lg border p-8 md:p-10 border-sky-500 rounded-lg hover:bg-sky-900 transition-all ease-in-out duration-300"
>
