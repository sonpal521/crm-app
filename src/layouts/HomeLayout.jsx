...
function HomeLayout({ children }) {
  ...
  return (
    <div className="min-h-[90vh] relative">
      <div className="drawer absolute left-0 right-0 cursor-pointer mt-4 ml-4 z-10">
        ...
        <div className="drawer-side">
          ...
          <ul className="menu p-4 lg:w-56 min-h-full bg-base-200 text-base-content">
            <li>
              <Link to="/">Home</Link>
            </li>
            ...
            <li className="absolute bottom-8 w-3/4 z-0">
